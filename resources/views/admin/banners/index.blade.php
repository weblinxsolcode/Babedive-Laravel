                    ...
                    <tbody>
                        @foreach ($list as $key => $item)
                            <tr>
                                ...
                                <td><strong>{{ ucfirst($item->text) }}</strong></td>
                                <td><img src="{{ asset('bannerImages/' . $item->banner_image) }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('admin.delete.banner', ['id' => $item->id]) }}"
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.store.banner') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="mb-2" for="">Text For Banner</label>
