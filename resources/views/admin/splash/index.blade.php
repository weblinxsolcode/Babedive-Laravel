...
@section('content')
                    ...
                    <tbody>
                        @foreach ($list as $key => $item)
                            <tr>
                                ...
                                <td><img src="{{ asset('splashImages/' . $item->image) }}"
                                        style="width: 150px; border-radius: 10px;" alt=""></td>
                            ...
                            <!-- Create Coupon Modal -->
                            <div class="modal fade" id="edit{{$loop->iteration}}" tabindex="-1" aria-labelledby="editUserModalLabel"
                                aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin.update.splash', ['id' => $item->id]) }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="heading"
                                                        placeholder="Enter Text" value="{{ old('heading') ?? $item->heading }}" required>
                                                </div>
                                                <div class="form-group my-2">
                                                    <label class="mb-2" for="">Banner (Optional)</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" class="form-control" placeholder="Please enter description" id="" cols="30"
                                                        rows="10" required>{{ old('description') ?? $item->description }}</textarea>
                                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('admin.delete.splash', ['id' => $item->id]) }}"
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <p><strong>Description :</strong>{{ ucfirst($item->description) }}</p>
                                                </div>
                                                <div class="text-center">
                                                    <img src="{{ asset('splashImages/' . $item->image) }}"
                                                        style="width: 350px; border-radius: 20px;" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="addBanner" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editUserModalLabel">Add Banner</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <!-- Body -->
                <div class="modal-body">
                    <form action="{{ route('admin.store.splash') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group my-2">
                            <label class="mb-2" for="">Banner</label>
